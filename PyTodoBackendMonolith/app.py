...
connection_string = Driver={ODBC Driver 18 for SQL Server};Server=tcp:sqlmayserver.database.windows.net,1433;Database=kds-sql;Uid=tondu_admin;Pwd=T0ndu!@#2025;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;
